export const dict = {
  ...
  "settings.external.open": "Open settings",
  "settings.external.unavailable": "This external settings panel is unavailable.",
  "settings.external.invalidUrl": "This external settings URL is invalid.",
